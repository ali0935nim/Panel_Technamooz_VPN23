# pages.py  -  Technamooz Panel v2.0.0
# شامل: LOGIN_HTML, DASHBOARD_HTML, get_public_page_html()

# لوگوی Technamooz (به‌صورت base64 داخلی، بدون نیاز به هاست خارجی)
...
<title>Technamooz Panel · ورود</title>
...
/* Technamooz Panel v2.0.0 — premium dark red / black visual system */
:root{
...
/* v2.0.0 glass system */
:root{--glass:rgba(20,20,27,.68);--glass-strong:rgba(25,25,33,.86);--glass-line:rgba(255,255,255,.10);--accent:#ef234f;--accent-soft:#ff5578}
body{background-color:#07070a!important;background-image:radial-gradient(900px 500px at 85% -10%,rgba(239,35,79,.18),transparent 62%),radial-gradient(700px 500px at 5% 90%,rgba(116,20,53,.14),transparent 60%)!important}
body:after{content:"";position:fixed;inset:0;pointer-events:none;opacity:.16;background-image:linear-gradient(rgba(255,255,255,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,#000 0%,transparent 78%);z-index:-1}
.sidebar{background:rgba(9,9,13,.78)!important;backdrop-filter:blur(26px)!important;border-left:1px solid rgba(239,35,79,.28)!important}
.logo{padding:24px 18px 20px!important;border-bottom:1px solid var(--glass-line)!important}.logo-img{width:44px!important;height:44px!important;border:1px solid rgba(239,35,79,.65)!important;box-shadow:0 0 28px rgba(239,35,79,.28)!important}.logo-name{font-size:15px!important}.logo-sub{font-size:10px!important;letter-spacing:.03em}
.nav-sec{color:#777780!important;font-size:10px!important;letter-spacing:.08em!important}.nav-it{margin:4px 12px!important;padding:12px 13px!important;border:1px solid transparent!important}.nav-it:hover,.nav-it.active,.nav-it.on{background:linear-gradient(100deg,rgba(239,35,79,.24),rgba(239,35,79,.06))!important;border:1px solid rgba(239,35,79,.23)!important;border-right:3px solid var(--accent)!important;box-shadow:inset 0 0 22px rgba(239,35,79,.06)!important}
.main{background:transparent!important}.topbar{padding:4px 2px 18px!important}.tb-title{font-size:21px!important;letter-spacing:-.03em!important}.tb-title i{filter:drop-shadow(0 0 8px rgba(239,35,79,.7))}
.card,.metric,.vless-box,.create-panel,.pw-panel,.srv-panel,.modal-v2,.modal,.lmodal-v2{background:linear-gradient(145deg,rgba(28,28,37,.74),rgba(12,12,17,.78))!important;backdrop-filter:blur(20px)!important;border:1px solid var(--glass-line)!important;box-shadow:0 22px 70px rgba(0,0,0,.30),inset 0 1px rgba(255,255,255,.035)!important}
.card:hover,.metric:hover,.srv-tile:hover{transform:translateY(-3px)!important;border-color:rgba(239,35,79,.38)!important;box-shadow:0 24px 75px rgba(0,0,0,.38),0 0 30px rgba(239,35,79,.10)!important}
.metric{border-radius:18px!important;padding:20px!important}.m-icon,.cp-head-icon,.pw-hero-icon,.srv-hero-icon{background:linear-gradient(135deg,rgba(239,35,79,.25),rgba(159,18,57,.10))!important;color:var(--accent-soft)!important;border:1px solid rgba(239,35,79,.24)!important;box-shadow:0 0 24px rgba(239,35,79,.12)!important}.m-val{font-size:28px!important}
.vless-box,.create-panel,.pw-panel,.srv-panel{border-radius:22px!important}.vl-code{background:rgba(4,4,7,.55)!important;border:1px solid rgba(239,35,79,.16)!important;border-radius:14px!important}.btn-p,.btn-main,.pw-submit{background:linear-gradient(135deg,#f12b57,#a90f39)!important}.btn-p:hover,.btn-main:hover,.pw-submit:hover{box-shadow:0 0 28px rgba(239,35,79,.33)!important}
input,select,textarea,.fi,.fs,.cp-input-full,.modal-v2-input,.pw-input{background:rgba(5,5,8,.60)!important;border-color:rgba(255,255,255,.12)!important;backdrop-filter:blur(8px)}input:focus,select:focus,textarea:focus{border-color:var(--accent)!important}
.srv-hero{background:linear-gradient(115deg,rgba(239,35,79,.22),rgba(23,23,30,.28))!important;border:1px solid rgba(239,35,79,.30)!important;box-shadow:0 0 35px rgba(239,35,79,.08)!important}.srv-tiles{gap:12px!important}.srv-tile{background:rgba(255,255,255,.035)!important;border-color:rgba(255,255,255,.09)!important;min-height:80px!important}.srv-tile-val{color:#fff!important}
.dash-footer{margin-top:28px!important;padding:20px 4px!important;border-top:1px solid var(--glass-line)!important;display:flex;gap:18px;flex-wrap:wrap;align-items:center;justify-content:space-between}.df-text{color:#85858e!important}.df-link{font-weight:700!important}
.theme-btn,.logout-btn{border-radius:12px!important}.theme-btn#lang-btn{font-weight:800;color:var(--accent-2);min-width:44px}.toast{backdrop-filter:blur(18px)!important;border:1px solid rgba(239,35,79,.35)!important}
@media(max-width:700px){.tb-title{font-size:18px!important}.dash-footer{justify-content:center;text-align:center}.df-text{width:100%}}
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="Technamooz Panel"></div>
      <div><div class="brand-name">Technamooz</div><div class="brand-sub">Panel v2.0.0</div></div>
    </div>
    ...
    <div class="err" id="err"><i class="ti ti-alert-circle"></i><span id="err-text"></span></div>
      ...
      <span class="hint-val">Amirparsa / Technamooz</span>
    </div>
    <form id="form">
      <div class="field">
    ...
    <div class="footer">پشتیبانی <a href="https://t.me/technamooz" target="_blank"><i class="ti ti-brand-telegram"></i>@technamooz</a></div>
  </div>
</div>
<script>
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="Technamooz Panel"></div>
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="Technamooz Panel"></div>
    <div><div class="logo-name">Technamooz</div><div class="logo-sub">Panel v2.0.0</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">Technamooz Panel v2.0.0 · ساخته‌شده با دقت برای Railway</span>
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="Technamooz Panel"></div>
      <div><div class="brand-name">Technamooz</div><div class="brand-sub">Panel v2.0.0</div></div>
    </div>
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/technamooz" target="_blank">@technamooz</a> · Technamooz Panel v2.0.0</div>
</div>
<script>
